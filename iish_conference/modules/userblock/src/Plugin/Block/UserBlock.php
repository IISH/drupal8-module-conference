<?php
namespace Drupal\iish_conference_userblock\Plugin\Block;
  ...
  public function build() {
    try {
      if (LoggedInUserDetails::isLoggedIn()) {
        ...
        $html = '<span class="conference-userblock">'
          . iish_t('Welcome') . ' '
      ...
      $html = '<span class="conference-userblock"></span>';
    }
    ...
    return array(
      ...
      '#markup' => $html,
      '#attached' => array(
        'library' => array('iish_conference_userblock/global-styling')
      ),
    );
  }
}